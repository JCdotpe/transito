...
class Local_controlador extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('local/local_model', 'modeloLocal');
    ...
    public function index() {
        ...
        $datos['titulo'] = "Listado de locales de aplicación";
        $datos['contenido'] = 'local/listado_local_vista';
